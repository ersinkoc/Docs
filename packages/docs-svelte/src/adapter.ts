/**
 * @oxog/docs-svelte - Svelte Adapter
 */
...
<body>
  <div id="svelte">${content.html}</div>
  <script type="module">console.log('Svelte adapter loaded');</script>
</body>
</html>`;
  }
...
export const svelteAdapter = createSvelteAdapter();
